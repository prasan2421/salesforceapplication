...
@section('title', 'Edit Sales Officer Beat')
...
<div class="row">
  <div class="col-12">
    <div class="card">
      {{ Form::model($routeUser, [ 'action' => [ 'SalesOfficerRouteController@update', request()->user_id, $routeUser->id ], 'method' => 'PUT' ]) }}
      <div class="card-body">
        @include('sales-officer-routes.form')
      </div>
      <div class="card-footer">
        <a href="{{ action('SalesOfficerRouteController@index', request()->user_id) }}" class="btn btn-primary">Back to List</a>
