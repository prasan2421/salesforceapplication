  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <a href="{{ action('SalesOfficerRouteController@create', request()->user_id) }}" class="btn btn-primary">Add Sales Officer Beat</a>
      </div>
      <div class="card-body">
...
<script type="text/javascript">
	$(function() {
		$('#data-table').DataTable({
	        processing: true,
	        serverSide: true,
	        ajax: '{{ action("SalesOfficerRouteController@getData", request()->user_id)}}',
	        columns: [
