...
@section('title', 'Add DSM')

@section('content')
<div class="row">
  <div class="col-12">
    <div class="card">
      {{ Form::open([ 'action' => 'DsmController@store' ]) }}
      <div class="card-body">
        @include('dsms.form')
      </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#is_non_parakram').change(function(){
      if($(this).is(':checked')) {
        $('#emp_code').attr('disabled', 'disabled').val('');
        $('#username').attr('disabled', 'disabled').val('');
      }
      else {
